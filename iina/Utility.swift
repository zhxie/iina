...
class Utility {
  ...
  static let screenshotCachePath: String = {
    let screenshotCacheURL = cacheURL.appendingPathComponent(AppData.screenshotCacheFolder, isDirectory: true)
    createDirIfNotExist(url: screenshotCacheURL)
    return screenshotCacheURL.path
  }()
  ...
  static func getLatestScreenshot(path: String) -> URL? {
